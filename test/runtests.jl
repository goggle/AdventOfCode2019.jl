...
@testset "Day 20" begin
    ...
    inp = "                   A               \n" *
          ...
          "           B   J   C               \n" *
          "           U   P   P               \n"
    @test AdventOfCode2019.Day20.solve(inp, (true, false)) == [58]
    ...
    inp = "             Z L X W       C                 \n" *
          ...
          "               A O F   N                     \n" *
          "               A A D   M                     \n"
    @test day20(inp) == [77, 396]

    @test day20() == [422, 5040]
end

@testset "Day 21" begin
    @test day21() == [19353074, 1147582556]
end

@testset "Day 22" begin
    @test day22() == [5540, 6821410630991]
end
